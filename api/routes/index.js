...
module.exports = (app) => {
  ...
  app.get("/api/jobDescription", (req, res) =>controller.jobDescription.index(req, res));
  ...
  app.delete("/api/jobDescription/:id", (req, res) =>controller.jobDescription.remove(req, res));
  ...
  app.get("/api/employeeBySearch/:searchBy", (req, res) =>
