...
export class EligibilityCriteriaComponent implements OnInit {
  ...
  loadEligibilityCriteria() {
    return this._service.getAllEligibilityCriterias().subscribe((response: any) => {
  ...
  eligibilityCriteria(): FormArray {
    return this.eligibilityCriterionForm.get("eligibilityCriteria") as FormArray
  }
  ...
  removeEligibilityCriterion(eligibilityIndex: number) {
    ...
    return this._service.deleteEligibilityCriterion(eligibilityIndex).subscribe((response: any) => {
