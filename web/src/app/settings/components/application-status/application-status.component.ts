...
export class ApplicationStatusComponent implements OnInit {
  ...
  loadApplicationStatusTypes() {
    return this._service.getAllApplicationStatusTypes().subscribe((response: any) => {
  ...
  applicationStatusTypes(): FormArray {
    return this.applicationStatusForm.get("applicationStatusTypes") as FormArray
  }
  ...
  removeApplicationStatus(appStatusIndex: number) {
    ...
    return this._service.deleteApplicationStatusType(appStatusIndex).subscribe((response: any) => {
